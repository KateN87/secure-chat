...
export const editContainer = document.querySelector('.editContainer');
export const createContainer = document.querySelector('.createContainer');
...
export const btnCreateChannel = document.querySelector('#btnCreateChannel');
